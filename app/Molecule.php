    ...
    public function addFigureLog($moleculeXml, $metaheader) {
        ...
        if($figureNodes) {
            ...
            foreach($figureNodes as $figureNode) {
                ...
                $sourceItem = isset($figureNode['credit'])? implode(' ', $figureNode['credit']): '';
                $sourceItem = htmlentities($sourceItem);

                $sourceItemFull = isset($figureNode['fullcredit'])? implode(' ', $figureNode['fullcredit']): '';
                $sourceItemFull = htmlentities($sourceItemFull);

                $caption = isset($figureNode['caption']) ? implode(' ', $figureNode['caption']) : '';
